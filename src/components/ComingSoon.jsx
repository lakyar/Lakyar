  ...
  return (
    <section className="relative flex min-h-screen items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 mx-auto max-w-4xl px-4 text-center">
        {/* Section Name */}
        <div className="mb-4 inline-block rounded-full bg-blue-50 px-4 py-2 text-sm font-medium text-blue-700 dark:bg-blue-900/30 dark:text-blue-300">
          {sectionName} Section
        </div>
        ...
        <h2 className="mb-6 text-5xl font-bold tracking-tight text-slate-900 sm:text-6xl md:text-7xl dark:text-white">
          ...
          <span className="relative inline-block">
            ...
            <span className="absolute -bottom-2 left-0 h-1 w-full animate-pulse bg-gradient-to-r from-blue-500 to-purple-500" />
          </span>
        </h2>
